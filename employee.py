...
models = {}
model_files = {
    "Attrition": "models/attrition_model.pkl",
    "Performance Rating": "models/performance_model.pkl",
    "Promotion Likelihood": "models/promotion_model.pkl",
    "Job Satisfaction": "models/satisfaction_model.pkl"
}
...
# -------------------------
    ...
    if st.button("Predict"):
        ...
        # -------------------------
        template = pd.read_csv("C:/Employee_attrition/cleaned_data.csv").iloc[0:1].drop(columns=['Attrition'])
